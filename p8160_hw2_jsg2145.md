...
| term    | estimate | lower | upper | deviance | p\_estimate |
| :------ | -------: | ----: | ----: | -------: | ----------: |
| logit   |     1.16 |  0.81 |  1.52 |     0.38 |        0.09 |
| probit  |     0.69 |  0.50 |  0.88 |     0.31 |        0.09 |
| cloglog |     0.75 |  0.53 |  0.96 |     2.23 |        0.13 |
...
x0fit_mph=-beta0_mph/beta1_mph
est_mph = x0fit_mph*1000

varx0_mph=betacov_mph[1,1]/(beta1_mph^2)+betacov_mph[2,2]*(beta0_mph^2)/(beta1_mph^4)-2*betacov_mph[1,2]*beta0_mph/(beta1_mph^3)
est_sd_mph = c(x0fit_mph,sqrt(varx0_mph))
ci_mph = (x0fit_mph+c(qnorm(0.025),-qnorm(0.025))*sqrt(varx0_mph))*1000
...
| term  | estimate | lower | upper |
| :---- | -------: | ----: | ----: |
| logit |    53235 | 40965 | 65505 |

On average, an offer of 53235 dollars would result in a 40% yield rate.
With 95% confidence, an offer of between 40965 dollars and 65505 dollars
